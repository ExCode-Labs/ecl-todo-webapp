...
const NotFound = () => {
  return (
    <div className="bg-[#F8FAFC] w-full h-[80vh] flex flex-col items-center">
      <img className="w-[50%] h-[60%] object-cover mt-10" src={image} alt="" />
      ...
      <div className="flex gap-4">
        <Link
          className="flex justify-center items-center gap-2 bg-indigo-600 text-white text-lg font-semibold mt-1 border-2 px-4 py-2 rounded-lg hover:bg-indigo-700 active:bg-indigo-800 transition-all duration-400"
          to="/todos"
        >
